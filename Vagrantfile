...
Vagrant.configure(2) do |config|
  ...
  system "wget -N -P #{IMAGE_PATH}/coreos_production_pxe.vmlinuz http://#{COREOS_CHANNEL}.release.core-os.net/amd64-usr/#{COREOS_RELEASE}/coreos_production_pxe.vmlinuz"
  system "wget -N -P #{IMAGE_PATH}/coreos_production_pxe_image.cpio.gz http://#{COREOS_CHANNEL}.release.core-os.net/amd64-usr/#{COREOS_RELEASE}/coreos_production_pxe_image.cpio.gz"
